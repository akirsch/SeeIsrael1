...
public class HikingPlacesFragment extends Fragment {
    ...
    public static HikingPlacesFragment instanceOfWithData (Places places){
        Bundle bundle = new Bundle();
        bundle.putParcelable("places-key", places);

        HikingPlacesFragment hikingPlacesFragment = new HikingPlacesFragment();
        hikingPlacesFragment.setArguments(bundle);
        return hikingPlacesFragment;
    }
