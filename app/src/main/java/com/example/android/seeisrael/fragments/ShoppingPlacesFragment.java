...
public class ShoppingPlacesFragment extends Fragment {
    ...
    public static ShoppingPlacesFragment instanceOfWithData (Places places){
        Bundle bundle = new Bundle();
        bundle.putParcelable("places-key", places);

        ShoppingPlacesFragment shoppingPlacesFragment = new ShoppingPlacesFragment();
        shoppingPlacesFragment.setArguments(bundle);
        return shoppingPlacesFragment;
    }
