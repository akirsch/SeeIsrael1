...
public class FamilyPlacesFragment extends Fragment {
    ...
    public FamilyPlacesFragment(){}

    // method to allow parent Fragment to pass data to child fragment upon initialization
    public static FamilyPlacesFragment instanceOfWithData (Places places){
        Bundle bundle = new Bundle();
        bundle.putParcelable("places-key", places);

        FamilyPlacesFragment familyPlacesFragment = new FamilyPlacesFragment();
        familyPlacesFragment.setArguments(bundle);
        return familyPlacesFragment;
    }
